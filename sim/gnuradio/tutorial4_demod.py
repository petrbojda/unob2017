...
# Title: Tutorial4 Demod
# Generated: Tue Dec  5 05:52:43 2017
##################################################
...
class tutorial4_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tutorial4 Demod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tutorial4 Demod")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "tutorial4_demod")
...
def main(top_block_cls=tutorial4_demod, options=None):
