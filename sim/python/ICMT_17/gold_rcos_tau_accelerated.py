...
f3ax1.plot(tc, CC_c,'-k', label='$h_{rect}(t)$')
f3ax1.grid(True)
...
f3ax1.axis([-0.25, 0.25, 30000, 253000])
...
#plt.title('Frequency Spectrum, $\\tau_A = 1.0$, $\\tau_B = 0.6$, $\\tau_C = 0.3$', loc='left')
#f4ax1.set_ylabel('$H^A(f)$')
#f4ax1.axis([-500, 1000, -1400, 2000])
...
f1ax2.plot(t, a1,'-g', label='$h_{rcos}(t), \\beta = 1.0$')
f1ax2.plot(t, a2,'-b', label='$h_{rcos}(t), \\beta = 0.5$')
f1ax2.plot(t, a3,'-r', label='$h_{rcos}(t), \\beta = 0.0$')
f1ax2.plot(t,  c,'-k', label='$h_{rect}(t)$')
f1ax2.grid(True)
...
f2ax2.plot(tc, CC_c,'-k', label='$h_{rect}(t)$')
f2ax2.grid(True)
f2ax2.set_ylabel('Baseband - voltage')
f2ax2.axis([-0.25, 0.25, 20000, 160000])
...
f3ax2.plot(tc, CC_c,'-k', label='$h_{rect}(t)$')
f3ax2.grid(True)
f3ax2.set_ylabel('Baseband - voltage')
f3ax2.axis([-0.25, 0.25, 40000, 160000])
...
#f4ax2.grid(True)
#f4ax2.set_ylabel('$H^B(f)$')
#f4ax2.axis([-500, 1000, 40000, 160000])
...
f1ax3.plot(t, a1,'-g', label='$h_{rcos}(t), \\beta = 1.0$')
f1ax3.plot(t, a2,'-b', label='$h_{rcos}(t), \\beta = 0.5$')
f1ax3.plot(t, a3,'-r', label='$h_{rcos}(t), \\beta = 0.0$')
f1ax3.plot(t,  c,'-k', label='$h_{rect}(t)$')
f1ax3.grid(True)
...
f2ax3.plot(tc, CC_c,'-k', label='$h_{rect}(t)$')
f2ax3.grid(True)
f2ax3.set_ylabel('Baseband - voltage')
f2ax3.set_xlabel('Time')
f2ax3.axis([-0.25, 0.25, 30000, 80000])
...
f3ax3.plot(tc, CC_c,'-k', label='$h_{rect}(t)$')
f3ax3.grid(True)
f3ax3.set_ylabel('Baseband - voltage')
f3ax3.set_xlabel('Time')
f3ax3.axis([-0.25, 0.25, 30000, 80000])
...
#f4ax3.grid(True)
#f4ax3.set_ylabel('$H^C(f)$')
#f4ax3.set_xlabel('Frequency')
#f4ax3.axis([-500, 1000, -1400, 1000])
