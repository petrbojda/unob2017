...
plt.title('Pulse-shaped Cross-Correlated, $\\tau_A = 1.0$, $\\tau_B = 0.8$, $\\tau_C = 0.5$', loc='left')
f3ax1.set_ylabel('$h^A(t)$')
...
f4ax1.plot(f,  C_fft,'-k', label='transmitted $T_{str}$')
f4ax1.grid(True)
...
f4ax2.plot(f,  C_fft,'-k', label='transmitted $T_{str}$')
f4ax2.grid(True)
...
f4ax3.plot(f,  C_fft,'-k', label='transmitted $T_{str}$')
f4ax3.grid(True)
...
f1.savefig('sequence_accelerated.eps',format='eps')
f2.savefig('sequence_accelerated_autocorr.eps',format='eps')
f3.savefig('sequence_accelerated_crosscorr.eps',format='eps')
f4.savefig('sequence_accelerated_fft.eps',format='eps')
plt.show()
